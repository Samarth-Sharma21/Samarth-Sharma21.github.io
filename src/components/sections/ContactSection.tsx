        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-secondary-light dark:text-secondary-dark mb-8">
              Feel free to contact me through any of the following channels. I'm looking 
              forward to hearing from you and discussing how we might work together.
            </p>
            ...
            <div className="card p-8">
              ...
              >
                {({ isSubmitting, touched, errors }) => (
                  <Form action="https://formsubmit.co/samarthsharma7621@gmail.com" method="POST">
                      ...
                      <div>
                        <div className="relative">
                          <Field
                            ...
                            name="name"
                            id="name"
                            className={`block w-full px-4 py-3 bg-gray-100 dark:bg-gray-800 border-2 border-transparent rounded-lg focus:outline-none focus:ring-0 focus:border-primary-light dark:focus:border-primary-dark transition-colors ${
